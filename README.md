...
- Backend Developer с фокусом на **Python + Flask**.
- Разрабатываю и поддерживаю **REST API**.
- Работаю с **PostgreSQL** и SQL-оптимизацией.
- Использую **Docker** и **Nginx** для деплоя и reverse proxy.
- Придерживаюсь **security-first mindset** и учитываю основы web security.
